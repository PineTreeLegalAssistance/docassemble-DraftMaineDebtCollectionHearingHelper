...
setup(name='docassemble.DraftMaineDebtCollectionHearingHelper',
      ...
      long_description='Debt Collection Hearing Helper tool for Maine',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/DraftMaineDebtCollectionHearingHelper/', package='docassemble.DraftMaineDebtCollectionHearingHelper'),
     )
